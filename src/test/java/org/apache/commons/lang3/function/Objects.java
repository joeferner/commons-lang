...
public class Objects {
     ...
     */
    public static <T> T requireNonNull(@Nullable final T value) throws NullPointerException {
     ...
     */
    public static <T, E extends Throwable> T requireNonNull(@Nullable final T value, @Nonnull final FailableSupplier<T, E> defaultValueSupplier) throws NullPointerException {
        if (value == null) {
     ...
     * @see #requireNonNull(Object, Supplier)
     */
    public static <T> T requireNonNull(@Nullable final T value, @Nonnull final String msg) throws NullPointerException {
        if (value == null) {
     ...
     * @see #requireNonNull(Object, String)
     */
    public static <T> T requireNonNull(@Nullable final T value, @Nonnull final Supplier<String> msgSupplier) throws NullPointerException {
        if (value == null) {
     ...
     * @see java.util.Objects#requireNonNull(Object)
     */
    public static <T> T requireNonNull(@Nullable final T value, @Nonnull final T defaultValue) throws NullPointerException {
